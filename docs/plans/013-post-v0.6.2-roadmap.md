...
- Option A: Daemon co-located with docs (single source of truth on build host; other devices query)
...
**Question:** Host B vs build host permanent home?
- Currently runs on build host as systemd user unit
