 ...
 */
function orderingToScores(ordering) {
 ...
 * to fusion scores.
 */
export async function llmRerank(query, documents, originalScores, options) {
    ...
    try {
        ...
        const result = orderingToScores(valid);
        ...
        console.warn("LLM reranker: request failed:", err.message);
        return null;
    }
}
